            ...
            if not file_checked:
                ...
                if not content_started:
                    ...
                    if line[0] == INFO_CHAR:
                        ...
                        raise Exception(f"ERROR! UNEXPECTED SYMBOL IN INFO SECTION: {line}")
                    ...
                    if line[0] == FRAME_CHAR:
                        if POSE_CHAR in line:
                            ...
                            if frame_index != len(file_frames):
                                raise Exception(f"ERROR! FRAME DATA NOT CONTINUOUS ON {line}")
                            ...
                            raise Exception(f"ERROR! UNEXPECTED CONTENT SYMBOL IN FRAME {line}")
                    else:
                        raise Exception(f"ERROR! UNEXPECTED SYMBOL IN CONTENT SECTION {line}")
